...
These are historical CUDA implementation and NVIDIA benchmark notes, not current
setup instructions. The project now uses Intel oneAPI SYCL; see README.md for
the current build and deployment workflow. The timings below do not describe Arc.
